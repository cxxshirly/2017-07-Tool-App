...
public class GreenFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            UtilLog.d("Fragement","Green:onCreate");
        }
    }
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragement","Green:onStart");
    ...
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragement","Green:onResume");
    ...
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragement","Green:onPause");
    ...
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragement","Green:onStop");
    ...
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragement","Green:onDestroy");

...
//        Log.d("Fragment","onCreate");
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragement","Red:onStart");
    ...
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragement","Red:onResume");
    ...
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragement","Red:onPause");
    ...
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragement","Red:onStop");
    ...
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragement","Red:onDestroy");

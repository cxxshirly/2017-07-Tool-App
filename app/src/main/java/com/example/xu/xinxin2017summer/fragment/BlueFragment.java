...
public class BlueFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragement","Blue:onStart");
    ...
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragement","Blue:onResume");
    ...
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragement","Blue:onPause");
    ...
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragement","Blue:onStop");
    ...
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragement","Blue:onDestroy");
